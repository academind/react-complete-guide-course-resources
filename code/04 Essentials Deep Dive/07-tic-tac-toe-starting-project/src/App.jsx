...
function App() {
  ...
  function handleSetSquare(rowIndex, colIndex) {
  ...
  return (
    <main>
      <div id="game-container">
        ...
        {(winner || hasDraw) && (
          <GameOver winner={winner} handleReset={handleRestart} />
        )}
        <GameBoard onSelectSquare={handleSetSquare} gameBoard={gameBoard} />
      </div>
      <Log turns={gameTurns} />
    </main>
  );
